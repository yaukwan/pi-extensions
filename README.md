...
| [`pi-paseo-background-terminal`](packages/pi-paseo-background-terminal) | Type commands directly into shared Paseo terminals and capture their visible output (`background_*` tools). | `pi install npm:pi-paseo-background-terminal` |
